        ...
        <main class="container mx-auto py-8 px-4">
            ...
            <div class="mb-8 bg-gray-800 rounded-lg shadow-lg p-6">
                ...
                <div class="grid grid-cols-3 gap-4 text-center">
                    <div
                        class="bg-red-900 rounded-lg p-4 transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
                    >
                        <p class="text-2xl font-bold">{{ rejected }}</p>
                        <p class="text-sm text-gray-300">Rejected</p>
                    </div>
                    <div
                        class="bg-sky-900 rounded-lg p-4 transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
                    >
                        <p class="text-2xl font-bold">{{ pending }}</p>
                        <p class="text-sm text-gray-300">Pending</p>
                    </div>
                    <div
                        class="bg-green-900 rounded-lg p-4 transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
                    >
            ...
            <!-- Add Camera Form -->
            <div
                class="mb-12 bg-gray-800 rounded-lg shadow-lg p-6 transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
            >
                    ...
                    >
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <img
                                    v-if="
                                        currentCamera.preview_image ||
                                        currentCamera.camera_image
                                    "
                                    :src="
                                        currentCamera.preview_image ||
                                        `/storage/${currentCamera.camera_image}`
                                    "
                                    alt="Camera Image"
                                    class="w-16 h-16 object-cover rounded-lg"
                                />
...
const handleModalFileUpload = (event) => {
    ...
    if (file) {
        currentCamera.camera_image = file; // Update with File object
        currentCamera.preview_image = URL.createObjectURL(file); // Create a temporary URL
    }
};
