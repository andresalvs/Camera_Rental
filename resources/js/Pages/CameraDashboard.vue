<template>
    ...
    >
        ...
        <main class="container mx-auto py-8 px-4">
            ...
            <h2 class="text-3xl font-bold mb-8 text-center">Manage Cameras</h2>

            <!-- Add Camera Form -->
            <div class="mb-12 bg-gray-800 rounded-lg shadow-lg p-6">
                ...
                >
                    ...
                    <div class="flex items-end">
                        <button
                            type="submit"
                            class="w-full bg-teal-600 hover:bg-teal-500 text-white px-6 py-2 rounded-lg transition-colors duration-200"
                        >
                            Add Camera
                        </button>
                    </div>
